                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 30px 15px;font-family:'Montserrat',sans-serif;" align="left">
                                                ...
                                                <div style="line-height: 150%; text-align: left; word-wrap: break-word;">
                                                    <p style="line-height: 150%; font-size: 14px;"><span style="font-size: 16px; line-height: 24px; color: #282828;">Bonjour {{$data['nom']}},</span></p>
                                                    <p style="line-height: 150%; font-size: 14px;">&nbsp;</p>
                                                    <p style="line-height: 150%; font-size: 14px;"><span style="font-size: 16px; line-height: 24px;">Veuillez prendre note que votre rendez-vous ci-dessous est annulé. Merci de votre compréhension</span></p>
                                                </div>
                                    ...
                                    <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:30px 30px 15px;font-family:'Montserrat',sans-serif;" align="left">
                                                ...
                                                <div style="line-height: 150%; text-align: left; word-wrap: break-word;">
                                                    <p style="line-height: 150%; text-align: center; font-size: 14px;"><span style="font-size: 20px; line-height: 30px;"><strong><span style="color: #282828; font-size: 20px; line-height: 30px;"><span style="line-height: 30px; font-size: 20px;"><u>Information sur le rendez-vous</u></span></span></strong></span></p>
                                                </div>
