...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="{{ URL::to('/') }}/images/logo.png" alt="img" title="" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: 120px;float: none;width: 100%;max-width: 580px;" width="580"/>
...
<p style="line-height: 150%; font-size: 14px;"><span style="font-size: 16px; line-height: 24px;">Nous avons bien reçu votre billet : {{$data['titre'] }}!</span></p>
  </div>
